      ...
      <div className="w-full max-w-md">
        <Card className="border-slate-800 bg-slate-900/80">
          <CardHeader className="space-y-2 text-center">
            <div className="mx-auto inline-flex items-center gap-2 rounded-full bg-slate-800/60 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-emerald-200">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <CardContent className="space-y-4">
              ...
              <p className="text-xs text-slate-400">This is mock auth. Replace with a real identity provider later.</p>
            </CardContent>
